...
var x = (r, e, t) => (Pn(r, e, "read from private field"), t ? t.call(r) : e.get(r)), pe = (r, e, t) => e.has(r) ? Li("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t), ce = (r, e, t, n) => (Pn(r, e, "write to private field"), n ? n.call(r, t) : e.set(r, t), t), ne = (r, e, t) => (Pn(r, e, "access private method"), t);
var dt = (r, e, t, n) => ({
  set _(s) {
    ce(r, e, s, t);
  },
...
var ir = { exports: {} }, In = {}, Qe = {}, ft = {}, kn = {}, On = {}, qn = {}, Bi;
function rn() {
...
function fn() {
  ...
  function v({ gen: R, validateName: N, schema: q, schemaEnv: M, opts: Y }, ie) {
    Y.code.es5 ? R.func(N, (0, o._)`${u.default.data}, ${u.default.valCxt}`, M.$async, () => {
      R.code((0, o._)`"use strict"; ${c(q, Y)}`), g(R, Y), R.code(ie);
    }) : R.func(N, (0, o._)`${u.default.data}, ${A(Y)}`, M.$async, () => R.code(c(q, Y)).code(ie));
  }
  function A(R) {
  ...
  function p(R) {
    const { schema: N, opts: q, gen: M } = R;
    v(R, () => {
      q.$comment && N.$comment && ee(R), U(R), M.let(u.default.vErrors, null), M.let(u.default.errors, 0), q.unevaluated && f(R), _(R), L(R);
    });
  }
  function f(R) {
  ...
  function b(R, N) {
    const { schema: q, gen: M, opts: Y } = R;
    Y.$comment && q.$comment && ee(R), H(R), te(R);
  ...
  function _(R, N) {
    if (R.opts.jtd)
      return W(R, [], !1, N);
    const q = (0, e.getSchemaTypes)(R.schema), M = (0, e.coerceAndCheckDataType)(R, q);
    W(R, q, !M, N);
  }
  function P(R) {
    const { schema: N, errSchemaPath: q, opts: M, self: Y } = R;
    N.$ref && M.ignoreKeywordsWithRef && (0, l.schemaHasRulesButRef)(N, Y.RULES) && Y.logger.warn(`$ref: keywords ignored in schema at path "${q}"`);
  }
  function U(R) {
    const { schema: N, opts: q } = R;
    N.default !== void 0 && q.useDefaults && q.strictSchema && (0, l.checkStrictMode)(R, "default is ignored in the schema root");
  }
  function H(R) {
  ...
  function ee({ gen: R, schemaEnv: N, schema: q, errSchemaPath: M, opts: Y }) {
    const ie = q.$comment;
    if (Y.$comment === !0)
  ...
  function L(R) {
    const { gen: N, schemaEnv: q, validateName: M, ValidationError: Y, opts: ie } = R;
    q.$async ? N.if((0, o._)`${u.default.errors} === 0`, () => N.return(u.default.data), () => N.throw((0, o._)`new ${Y}(${u.default.vErrors})`)) : (N.assign((0, o._)`${M}.errors`, u.default.vErrors), ie.unevaluated && B(R), N.return((0, o._)`${u.default.errors} === 0`));
  }
  function B({ gen: R, evaluated: N, props: q, items: M }) {
    q instanceof o.Name && R.assign((0, o._)`${N}.props`, q), M instanceof o.Name && R.assign((0, o._)`${N}.items`, M);
  }
  function W(R, N, q, M) {
    ...
    function wt(Oe) {
      (0, t.shouldUseGroup)(ie, Oe) && (Oe.type ? (Y.if((0, n.checkDataType)(Oe.type, De, Ne.strictNumbers)), z(R, Oe), N.length === 1 && N[0] === Oe.type && q && (Y.else(), (0, n.reportTypeError)(R)), Y.endIf()) : z(R, Oe), Be || Y.if((0, o._)`${u.default.errors} === ${M || 0}`));
    }
  }
  function z(R, N) {
    const { gen: q, schema: M, opts: { useDefaults: Y } } = R;
    Y && (0, s.assignDefaults)(R, N.type), q.block(() => {
  ...
  function E(R, N) {
    ...
    for (const M of R.dataTypes)
      T(N, M) ? q.push(M) : N.includes("integer") && M === "number" && q.push("integer");
    R.dataTypes = q;
  }
  function $(R, N) {
    const q = R.schemaEnv.baseId + R.errSchemaPath;
    N += ` at "${q}" (strictTypes)`, (0, l.checkStrictMode)(R, N, R.opts.strictTypes);
  }
  class k {
    constructor(N, q, M) {
      if ((0, i.validateKeywordUsage)(N, q, M), this.gen = N.gen, this.allErrors = N.allErrors, this.keyword = M, this.data = N.data, this.schema = N.schema[M], this.$data = q.$data && N.opts.$data && this.schema && this.schema.$data, this.schemaValue = (0, l.schemaRefOrVal)(N, this.schema, M, this.$data), this.schemaType = q.schemaType, this.parentSchema = N.schema, this.params = {}, this.it = N, this.def = q, this.$data)
    ...
    result(N, q, M) {
      this.failResult((0, o.not)(N), q, M);
    }
    failResult(N, q, M) {
      this.gen.if(N), M ? M() : this.error(), q ? (this.gen.else(), q(), this.allErrors && this.gen.endIf()) : this.allErrors ? this.gen.endIf() : this.gen.else();
    }
    pass(N, q) {
    ...
    error(N, q, M) {
      if (q) {
        this.setParams(q), this._error(N, M), this.setParams({});
        return;
      }
      this._error(N, M);
    }
    _error(N, q) {
      (N ? h.reportExtraError : h.reportError)(this, this.def.error, q);
    }
    $dataError() {
    ...
    block$data(N, q, M = o.nil) {
      this.gen.block(() => {
        this.check$data(N, M), q();
      });
    }
    check$data(N = o.nil, q = o.nil) {
      ...
      M.if((0, o.or)((0, o._)`${Y} === undefined`, q)), N !== o.nil && M.assign(N, !0), (ie.length || De.validateSchema) && (M.elseIf(this.invalid$data()), this.$dataError(), N !== o.nil && M.assign(N, !1)), M.else();
    }
    invalid$data() {
      const { gen: N, schemaCode: q, schemaType: M, def: Y, it: ie } = this;
      return (0, o.or)(De(), Be());
      function De() {
        if (M.length) {
          ...
          return (0, o._)`${(0, n.checkDataTypes)(Ne, q, ie.opts.strictNumbers, n.DataType.Wrong)}`;
        }
        return o.nil;
      }
      function Be() {
    ...
    mergeEvaluated(N, q) {
      ...
      M.opts.unevaluated && (M.props !== !0 && N.props !== void 0 && (M.props = l.mergeEvaluated.props(Y, N.props, M.props, q)), M.items !== !0 && N.items !== void 0 && (M.items = l.mergeEvaluated.items(Y, N.items, M.items, q)));
    }
    mergeValidEvaluated(N, q) {
      const { it: M, gen: Y } = this;
      if (M.opts.unevaluated && (M.props !== !0 || M.items !== !0))
        return Y.if(q, () => this.mergeEvaluated(N, o.Name)), !0;
    }
  }
  Qe.KeywordCxt = k;
  function X(R, N, q, M) {
    const Y = new k(R, q, N);
    "code" in q ? q.code(Y, M) : Y.$data && q.validate ? (0, i.funcKeywordCode)(Y, q) : "macro" in q ? (0, i.macroKeywordCode)(Y, q) : (q.compile || q.validate) && (0, i.funcKeywordCode)(Y, q);
  }
  const J = /^\/(?:[^~]|~0|~1)*$/, le = /^([0-9]+)(#|\/(?:[^~]|~0|~1)*)?$/;
  function oe(R, { dataLevel: N, dataNames: q, dataPathArr: M }) {
    let Y, ie;
    if (R === "")
...
function Ac() {
  return fa || (fa = 1, function(r) {
    ...
    function m(I) {
      var S, F, T, E, $, k, X, J, le, oe, R, N, q, M, Y, ie, De, Be, Ne, Fe, we, wt, Oe, Tn, Nn;
      const xt = I.strict, Fn = (S = I.code) === null || S === void 0 ? void 0 : S.optimize, qi = Fn === !0 || Fn === void 0 ? 1 : Fn || 0, xi = (T = (F = I.code) === null || F === void 0 ? void 0 : F.regExp) !== null && T !== void 0 ? T : v, rc = (E = I.uriResolver) !== null && E !== void 0 ? E : y.default;
      return {
        strictSchema: (k = ($ = I.strictSchema) !== null && $ !== void 0 ? $ : xt) !== null && k !== void 0 ? k : !0,
        strictNumbers: (J = (X = I.strictNumbers) !== null && X !== void 0 ? X : xt) !== null && J !== void 0 ? J : !0,
        strictTypes: (oe = (le = I.strictTypes) !== null && le !== void 0 ? le : xt) !== null && oe !== void 0 ? oe : "log",
        strictTuples: (N = (R = I.strictTuples) !== null && R !== void 0 ? R : xt) !== null && N !== void 0 ? N : "log",
        strictRequired: (M = (q = I.strictRequired) !== null && q !== void 0 ? q : xt) !== null && M !== void 0 ? M : !1,
        code: I.code ? { ...I.code, optimize: qi, regExp: xi } : { optimize: qi, regExp: xi },
...
function Lc() {
  ...
  const r = Sc(), e = Rc(), t = Nc(), n = Fc(), s = Pc(), i = Ic(), a = kc(), o = Oc(), u = qc(), d = xc(), l = [
    // number
    r.default,
    e.default,
    // string
...
function Wc() {
  if (Ma) return qr;
  Ma = 1, Object.defineProperty(qr, "__esModule", { value: !0 });
  const r = ae(), e = ue(), n = {
    keyword: "oneOf",
    schemaType: "array",
    trackErrors: !0,
...
function Xc() {
  if (Ua) return xr;
  Ua = 1, Object.defineProperty(xr, "__esModule", { value: !0 });
  const r = ue(), e = {
    keyword: "allOf",
    schemaType: "array",
    code(t) {
...
var Jr = /* @__PURE__ */ new Map([
   ...
   */
  next() {
    if (x(this, Ue) >= x(this, at).length - 1)
      return ne(this, on, pl).call(this), -1;
    dt(this, Ue)._++;
    const r = x(this, at).charCodeAt(x(this, Ue));
    return x(this, vt) ? (dt(this, Qt)._++, ce(this, bt, 1), ce(this, vt, !1)) : dt(this, bt)._++, r === Sf ? (ce(this, vt, !0), this.peek() === so && dt(this, Ue)._++) : r === so && ce(this, vt, !0), ce(this, Tt, r), r;
  }
  /**
   ...
   */
  peek() {
    return x(this, Ue) === x(this, at).length - 1 ? -1 : x(this, at).charCodeAt(x(this, Ue) + 1);
  }
  /**
 ...
 */
pl = function() {
  x(this, Zt) || (dt(this, bt)._++, dt(this, Ue)._++, ce(this, Tt, -1), ce(this, Zt, !0));
...
function Gn(r) {
  return tt(r) || r >= dl && r <= xd || r >= ul && r <= mi;
}
function kf(r) {
  return r >= Rd && r <= al;
}
...
var ot, un, G, $e, Nt, ln, Se, er, tr, rr, nr, Z, _e, yl, Gt, Le, Qr, Zr, Qs, Zs, ei, Uu, xf = (Uu = class {
  /**
  ...
  constructor(r, e) {
    ...
    ce(this, un, r), ce(this, ot, {
      ...Pf,
      ...e
    }), ce(this, G, new Rf(r)), ce(this, $e, x(this, ot).mode === "json5"), ce(this, Nt, x(this, ot).mode !== "json"), ce(this, ln, x(this, ot).ranges), ce(this, er, x(this, $e) ? sn.has.bind(sn) : Yt.has.bind(Yt)), ce(this, tr, x(this, $e) ? Xs.has.bind(Xs) : () => !1), ce(this, rr, x(this, $e) ? (t) => t === ro : () => !1), ce(this, nr, x(this, $e) ? io.has.bind(io) : Ys.has.bind(Ys));
  }
  // #endregion
  /**
  ...
  next() {
    let r = x(this, G).next();
    for (; x(this, nr).call(this, r); )
      r = x(this, G).next();
    if (r === -1)
      return he.EOF;
    const e = x(this, G).locate(), t = String.fromCharCode(r);
    if (x(this, $e))
      if (Hr.has(t))
      ...
      } else if (ao(r, x(this, $e))) {
        const n = ne(this, Z, Qs).call(this, r), s = x(this, G).locate();
        ce(this, Se, ne(this, Z, Le).call(this, "String", n, e, {
          line: s.line,
          column: s.column + 1,
          offset: s.offset + 1
        }));
      } else if (r === Ht && x(this, Nt)) {
        const n = ne(this, Z, ei).call(this, r), s = x(this, G).locate();
 ...
 */
_e = function(r, e = x(this, G).locate()) {
  throw new Af(r, e);
}, /**
 ...
 */
yl = function(r, e = x(this, G).locate()) {
  throw new Cf(r, e);
}, /**
...
Qr = function(r) {
  let e = "", t;
  for (let n = 0; n < r; n++) {
    if (t = x(this, G).peek(), Gn(t)) {
      x(this, G).next(), e += String.fromCharCode(t);
      continue;
    }
...
Zr = function(r) {
  ...
  do {
    if (e += String.fromCharCode(r), r === Kt) {
      r = x(this, G).next(), r !== to && ne(this, Z, _e).call(this, r), e += String.fromCharCode(r);
      const t = ne(this, Z, Qr).call(this, 4), n = parseInt(t, 16);
      if (e.length === 2 && !Js(n)) {
        const s = x(this, G).locate();
...
Qs = function(r) {
  const e = r;
  let t = 1;
  for (r = x(this, G).peek(); r !== -1 && r !== e; ) {
    if (x(this, G).next(), t++, r === Kt)
      if (r = x(this, G).peek(), x(this, er).call(this, r) || x(this, tr).call(this, r))
        x(this, G).next(), t++;
      else if (r === to) {
        x(this, G).next(), t++;
        const n = ne(this, Z, Qr).call(this, 4);
        t += n.length;
      } else if (x(this, rr).call(this, r)) {
        x(this, G).next(), t++;
        const n = ne(this, Z, Qr).call(this, 2);
        t += n.length;
      } else x(this, $e) ? (x(this, G).next(), t++) : ne(this, Z, _e).call(this, r);
    r = x(this, G).peek();
  }
  return r === -1 && (x(this, G).next(), ne(this, Z, Gt).call(this)), x(this, G).next(), t++, t;
}, /**
...
Zs = function(r) {
  let e = 1;
  if (r === zs || x(this, $e) && r === Ks) {
    if (r = x(this, G).peek(), x(this, $e) && (r === Hd || r === Ld)) {
      x(this, G).next();
      const t = ne(this, Z, Zr).call(this, r);
      return t !== Tf && t !== Nf && ne(this, Z, _e).call(this, r), e + t.length;
    }
    tt(r) || ne(this, Z, _e).call(this, r), x(this, G).next(), e++;
  }
  if (r === hi)
    if (r = x(this, G).peek(), x(this, $e) && (r === ro || r === Bd)) {
      x(this, G).next(), e++, r = x(this, G).peek(), Gn(r) || (x(this, G).next(), ne(this, Z, _e).call(this, r));
      do
        x(this, G).next(), e++, r = x(this, G).peek();
      while (Gn(r));
    } else tt(r) && ne(this, Z, _e).call(this, r);
  else if (!x(this, $e) || r !== Gs)
    for (kf(r) || ne(this, Z, _e).call(this, r), r = x(this, G).peek(); tt(r); )
      x(this, G).next(), e++, r = x(this, G).peek();
  if (r === Gs) {
    let t = -1;
    for (x(this, G).next(), e++, t++, r = x(this, G).peek(); tt(r); )
      x(this, G).next(), e++, t++, r = x(this, G).peek();
    !x(this, $e) && t === 0 && (x(this, G).next(), r ? ne(this, Z, _e).call(this, r) : ne(this, Z, Gt).call(this));
  }
  if (r === Nd || r === qd)
    for (x(this, G).next(), e++, r = x(this, G).peek(), (r === Ks || r === zs) && (x(this, G).next(), e++, r = x(this, G).peek()), r === -1 && (x(this, G).next(), ne(this, Z, Gt).call(this)), tt(r) || (x(this, G).next(), ne(this, Z, _e).call(this, r)); tt(r); )
      x(this, G).next(), e++, r = x(this, G).peek();
  return e;
}, /**
...
ei = function(r) {
  let e = 1;
  if (r = x(this, G).peek(), r === Ht) {
    do
      x(this, G).next(), e += 1, r = x(this, G).peek();
    while (r > -1 && r !== gi && r !== pi);
    return { length: e, multiline: !1 };
  }
  if (r === no) {
    for (x(this, G).next(), e += 1; r > -1; )
      if (r = x(this, G).peek(), r === no) {
        if (x(this, G).next(), e += 1, r = x(this, G).peek(), r === Ht)
          return x(this, G).next(), e += 1, { length: e, multiline: !0 };
      } else
        x(this, G).next(), e += 1;
    x(this, G).next(), ne(this, Z, Gt).call(this);
  }
  x(this, G).next(), ne(this, Z, _e).call(this, r);
}, Uu), qe = {
  /**
...
function Vf(r, e) {
  ...
  function v(b) {
    ...
    if (b.type !== "Identifier") {
      let H = "";
      return (_[0] === "+" || _[0] === "-") && (H = _[0]), qe[_.includes("NaN") ? "nan" : "infinity"](
        /** @type {Sign} */
        H,
        U
      );
    }
    return qe.identifier(jf(_), U);
  }
  function A(b) {
  ...
  function g(b) {
    ...
    if (s && (_.type === "NaN" || _.type === "Infinity")) {
      if (_.sign !== "")
        throw new _t(n.token);
      _ = qe.identifier(_.type, { loc: _.loc, ...h(_.loc.start, _.loc.end) });
    }
    b = u(), d(b, he.Colon);
...
function Te() {
  if (yo) return Yn;
  yo = 1;
  const r = bn(), { MAX_LENGTH: e, MAX_SAFE_INTEGER: t } = yn(), { safeRe: n, t: s } = sr(), i = bi(), { compareIdentifiers: a } = Al();
  class o {
    constructor(d, l) {
      if (l = i(l), d instanceof o) {
        if (d.loose === !!l.loose && d.includePrerelease === !!l.includePrerelease)
          return d;
        d = d.version;
      ...
      r("SemVer", d, l), this.options = l, this.loose = !!l.loose, this.includePrerelease = !!l.includePrerelease;
      const h = d.trim().match(l.loose ? n[s.LOOSE] : n[s.FULL]);
      if (!h)
        throw new TypeError(`Invalid Version: ${d}`);
      if (this.raw = d, this.major = +h[1], this.minor = +h[2], this.patch = +h[3], this.major > t || this.major < 0)
        throw new TypeError("Invalid major version");
      if (this.minor > t || this.minor < 0)
        throw new TypeError("Invalid minor version");
      if (this.patch > t || this.patch < 0)
        throw new TypeError("Invalid patch version");
      h[4] ? this.prerelease = h[4].split(".").map((y) => {
        if (/^[0-9]+$/.test(y)) {
          const v = +y;
          if (v >= 0 && v < t)
            return v;
    ...
    compare(d) {
      if (r("SemVer.compare", this.version, this.options, d), !(d instanceof o)) {
    ...
    compareMain(d) {
      return d instanceof o || (d = new o(d, this.options)), a(this.major, d.major) || a(this.minor, d.minor) || a(this.patch, d.patch);
    }
    comparePre(d) {
      ...
      let l = 0;
      do {
        const h = this.prerelease[l], y = d.prerelease[l];
        if (r("prerelease compare", l, h, y), h === void 0 && y === void 0)
          return 0;
        if (y === void 0)
          return 1;
        if (h === void 0)
    ...
    compareBuild(d) {
      ...
      let l = 0;
      do {
        const h = this.build[l], y = d.build[l];
        if (r("build compare", l, h, y), h === void 0 && y === void 0)
          return 0;
        if (y === void 0)
          return 1;
        if (h === void 0)
    ...
    inc(d, l, h) {
      if (d.startsWith("pre")) {
        ...
        if (l) {
          const y = `-${l}`.match(this.options.loose ? n[s.PRERELEASELOOSE] : n[s.PRERELEASE]);
          if (!y || y[1] !== l)
      ...
      switch (d) {
        ...
        case "pre": {
          ...
          if (l) {
            let v = [l, y];
            h === !1 && (v = [l]), a(this.prerelease[0], l) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = v) : this.prerelease = v;
          }
          break;
        }
        default:
...
function Uh() {
  if (ru) return Os;
  ru = 1;
  const r = sr(), e = yn(), t = Te(), n = Al(), s = kt(), i = bh(), a = vh(), o = Eh(), u = Dh(), d = wh(), l = Ah(), h = Ch(), y = $h(), v = Ke(), A = _h(), g = Sh(), p = vi(), f = Rh(), c = Th(), m = vn(), D = Ei(), w = Cl(), b = $l(), C = Di(), _ = wi(), P = _l(), U = Nh(), H = En(), te = We(), ee = Dn(), L = Ph(), B = Ih(), W = kh(), z = Oh(), V = qh(), K = Ai(), I = xh(), S = Lh(), F = Bh(), T = jh(), E = Mh();
  return Os = {
    parse: s,
    valid: i,
    clean: a,
...
class Je extends Array {
  constructor(t, n) {
    var e = (...OE) => (super(...OE), O(this, "value"), O(this, "locations"), this);
...
const cu = Symbol(Ot.name), du = Symbol(qt.name), fu = Symbol(Cn.name), Rt = Symbol(Ol.name), hu = Symbol($n.name);
function lt(r) {
  return !(Ot(r) || Ol(r) || qt(r) || Cn(r) || $n(r));
}
function Pp(r) {
  const e = (t) => {
...
function Ip(r) {
  ...
  return {
    byParent: r.parent ? qt(r.parent) : !1,
    bySelf: e(r)
  };
}
function qt(r, e) {
...
const _n = Dt.name, qp = Symbol(`${_n}|html`), xp = Symbol(`${_n}|a11y`), Lp = Symbol(`${_n}|html|ignore-hidden-root`), Bp = Symbol(`${_n}|a11y|ignore-hidden-root`);
...
function ql(r, e) {
  ...
  for (const s of r.childNodes)
    if (_i(s))
      ...
      if (qt(s, !0).bySelf || t && Ot(s, !0).bySelf)
        continue;
      n = n.concat(ql(s, e));
    }
  return n;
...
class ag extends j {
  constructor(t) {
    super({ ...ig, ...t });
    O(this, "style");
    this.style = new xl(this.options.style, "attr-case");
  }
  static schema() {
...
class gy extends j {
  constructor(t) {
    super({ ...py, ...t });
    O(this, "style");
    this.style = new xl(this.options.style, "element-case");
  }
  static schema() {
    const t = ["lowercase", "uppercase", "pascalcase", "camelcase"];
    return {
...
function by(r) {
  const { tagName: e, meta: t } = r;
  return !!(e === "template" && (t != null && t.templateRoot) && (t != null && t.scriptSupporting));
}
function vy(r, e) {
...
`),
  ...
  validatePermittedContentImpl(e, t, n) {
    ...
    return (s = e.meta) != null && s.transparent ? vy(e, e.meta.transparent).map((a) => this.validatePermittedContentImpl(a, t, n)).some(Boolean) : !1;
  }
  validatePermittedDescendant(e, t) {
    for (let n = t; n && !n.isRootElement() && !by(n); n = /* istanbul ignore next */
    n.parent ?? null) {
      const s = n.meta;
      if (!s)
        continue;
...
function _y(r, e, t) {
  ...
  const i = nt(t.filter(Ti).map(Cy));
  return `${n} element requires a ${i} element as parent`;
}
class Sy extends j {
  documentation(e) {
    return {
      description: $y(e).join(`
`),
...
`),
  ...
  validateRequiredAncestors(e) {
    ...
    if (!t || ye.validateAncestors(e, t))
      return;
    const n = t.map((o) => Ry(o) ? `<${o}>` : `"${o}"`), s = `<${e.tagName}>`, i = `<${e.tagName}> element requires a ${nt(n)} ancestor`, a = {
      ancestor: n,
      child: s
    };
        ...
        if (s)
          for (const i of ye.validateRequiredContent(n, s)) {
            const a = {
              ...
              missing: `<${i}>`
            }, o = Py(i) ? `${i.slice(1)} element` : `<${i}>`, u = `${n.annotatedName} element must have ${o} as content`;
...
const ky = ["h1", "h2", "h3", "h4", "h5", "h6"].join(",");
function Oy(r) {
...
function Uy(r, e, t) {
  ...
  return !(!n || !e.potentialHiddenDefault || !My(r));
}
function Vy(r) {
...
class Hy extends j {
  ...
  setup() {
    ...
    this.on("dom:ready", (n) => {
      const { document: s } = n, i = s.querySelectorAll(e), [a, o] = Up(i, (u) => By(u, t));
      for (const u of o) {
...
class Xy extends j {
  constructor(t) {
    ...
    O(this, "sectionRoots");
    O(this, "stack", []);
    this.minInitialRank = Wy(this.options.minInitialRank), this.sectionRoots = this.options.sectioningRoots.map((n) => new Pl(n)), this.stack.push({
      node: null,
      current: 0,
      h1Count: 0
    });
...
function Jy(r) {
  ...
  return e !== null ? e >= 0 : !t || Yy(r, t) ? !1 : !!t.focusable;
}
function Ml(r) {
  const e = r.cacheGet(Au);
  return e || r.cacheSet(Au, Jy(r));
}
class Qy extends j {
  documentation(e) {
    return {
...
function Ni(r, e) {
  ...
  return !!(Dt(r, { accessible: !0, ignoreHiddenRoot: n }) !== He.EMPTY_TEXT || sb(r, e) || ib(r) || ab(r, e));
}
function ai(r, e) {
  if (e.cacheExists(js))
  ...
  setup() {
    this.on("element:ready", ({ target: e }) => {
      ...
      if (!(n != null && n.value) || n.isDynamic)
        return;
      const s = n.valueLocation, i = pb(n.value.toString());
      if (!i) {
...
class Mb extends j {
  ...
  setup() {
    this.on("dom:ready", (e) => {
      ...
      for (const { property: n, isList: s } of jb)
...
const Vb = {
  relaxed: !1
}, Hb = /([<>]|&(?![a-zA-Z0-9#]+;))/g, Gb = /([<>"'=`]|&(?![a-zA-Z0-9#]+;))/g, zb = /^(<%.*?%>|<\?.*?\?>|<\$.*?\$>)$/s, Kb = {
  '"': "&quot;",
  "&": "&amp;",
  "'": "&apos;",
  "<": "&lt;",
  ...
  setup() {
    this.on("element:ready", (t) => {
      ...
      for (const s of n.childNodes)
        s.nodeType === Ye.TEXT_NODE && (zb.exec(s.textContent) || this.findRawChars(n, s.textContent, s.location, Hb));
    }), this.on("attr", (t) => {
      const { meta: n } = t;
      t.value && (t.quote || n != null && n.boolean || this.findRawChars(
        t.target,
        t.value.toString(),
        t.valueLocation,
  ...
  findRawChars(t, n, s, i) {
    ...
    do
      if (a = i.exec(n), a) {
        ...
        if (this.relaxed && o === "&")
          continue;
        const u = Kb[o], d = ve(s, a.index, a.index + 1);
        this.report(t, `Raw "${o}" must be encoded as "${u}"`, d);
      }
    while (a);
  }
}
const Xb = ["input[aria-label]", "textarea[aria-label]", "select[aria-label]"];
class Yb extends j {
  documentation() {
    return {
  ...
  setup() {
    this.on("dom:ready", (e) => {
      const { document: t } = e, n = t.querySelectorAll(Xb.join(","));
      for (const s of n) {
...
class t0 extends j {
  ...
  setup() {
    this.on("tag:end", (e) => {
      const t = e.previous;
      r0(t, this.options) && this.validateElement(t);
    });
  }
  validateElement(e) {
...
function r0(r, e) {
  return Zb.exec(r.tagName) ? !e.ignoreXML : r.meta ? r.meta.void ? !1 : r.meta.foreign ? !e.ignoreForeign : !0 : !0;
}
class n0 extends j {
  documentation() {
    return {
...
const l0 = ["button", "submit", "reset", "image"], c0 = {
...
class f0 extends j {
  ...
  documentation(e) {
    ...
    return {
      description: `Prefer to use \`${c0[e.type] || "<button>"}\` instead of \`"${t}\`.`,
  ...
  setup() {
    this.on("attr", (e) => {
      ...
      if (this.isKeywordIgnored(n) || !l0.includes(n))
        return;
...
const b0 = {
  ...
  link: "href",
  script: "src"
}, E0 = ["stylesheet", "preload", "modulepreload"], D0 = ["style", "script"];
function w0(r) {
  const e = r.getAttribute("rel");
  if (typeof (e == null ? void 0 : e.value) != "string" || !E0.includes(e.value))
    return !1;
  if (e.value === "preload") {
    const t = r.getAttribute("as");
    return typeof (t == null ? void 0 : t.value) == "string" && D0.includes(t.value);
  }
  return !0;
}
class A0 extends j {
  ...
  needSri(t) {
    ...
    if (!n || n.value === null || n.value === "" || n.isDynamic)
      return !1;
    const s = n.value.toString();
    return this.target === "all" || v0.test(s) ? !this.isIgnored(s) : !1;
  }
  elementSourceAttr(t) {
...
class P0 extends j {
  constructor(t) {
    super({ ...R0, ...t });
    O(this, "regex");
    this.regex = T0(this.options.characters);
  }
  static schema() {
    return {
      characters: {
...
`),
  ...
  detectDisallowed(t, n) {
    const [s, i] = N0(n), a = F0(i, this.regex);
    for (const o of a) {
...
function Ul(r) {
  return lt(r) ? r.childNodes.some((t) => k0(t)) || Ms(r, "aria-label") || Ms(r, "aria-labelledby") || r.is("img") && Ms(r, "alt") || I0(r) ? !0 : r.childElements.some((t) => Ul(t)) : !1;
}
class Fi extends j {
  documentation(e) {
    const t = {
...
const Vl = ["complementary", "contentinfo", "form", "banner", "main", "navigation", "region"], O0 = [
  "aside",
  "footer",
  "form",
  "header",
...
`),
  ...
  setup() {
    this.on("dom:ready", (e) => {
      const { document: t } = e, n = t.querySelectorAll(O0.join(",")).filter((i) => typeof i.role == "string" && Vl.includes(i.role)), s = x0(n, (i) => i.role);
      for (const i of Object.values(s)) {
        if (i.length <= 1)
          continue;
        const a = i.map((u) => L0(t, u)), o = a.filter(B0);
        for (const u of o) {
...
const M0 = {
  ignoreCase: !1,
  requireSemicolon: !0
}, U0 = /&(?:[a-z0-9]+|#x?[0-9a-f]+)(;|[^a-z0-9]|$)/gi, V0 = Ju.map((r) => r.toLowerCase());
function H0(r) {
  return r.startsWith("&#");
}
function Fu(r, e, t) {
...
class z0 extends j {
  ...
  get entities() {
    return this.options.ignoreCase ? V0 : Ju;
  }
...
const K0 = ["section", "hint", "contact", "field1", "field2", "webauthn"], W0 = [
  "name",
  "honorific-prefix",
  "given-name",
  "additional-name",
...
function ev(r) {
  return X0.includes(r);
}
function tv(r) {
  return r === "webauthn";
}
function rv(r) {
  return Y0(r) ? "section" : J0(r) ? "hint" : Q0(r) ? "field1" : ev(r) ? "field2" : Z0(r) ? "contact" : tv(r) ? "webauthn" : null;
}
function zl(r) {
  const e = [
    "text",
...
class cv extends j {
  constructor(t) {
    super({ ...lv, ...t });
    O(this, "style");
    this.style = dv(this.options.style);
  }
  static schema() {
    return {
      style: {
...
class mv extends j {
  ...
  setup() {
    ...
    this.on("dom:ready", (n) => {
      ...
      for (const a of i)
        gv(a) || yv(s, a) || this.report(a, `<${a.tagName}> element must have a submit button`);
    });
  }
}
function Kl(r) {
...
function yv(r, e) {
  const { id: t } = e;
  return t ? r.querySelectorAll("button[form],input[form]").filter(Kl).filter((s) => pv(t, s)).length > 0 : !1;
}
class bv extends j {
  documentation() {
    return {
...
class Ev extends j {
  constructor(e) {
    super({ ...vv, ...e }), Array.isArray(this.options.alias) || (this.options.alias = [this.options.alias]);
  }
  static schema() {
    return {
      alias: {
...
var Vu;
const { enum: Wl } = (Vu = Yu.th.attributes) == null ? void 0 : Vu.scope, wv = nt(Wl), Av = 0, Cv = 1;
function $v(r) {
  const e = r.length, t = r[0].length;
  return { rows: e, cols: t };
}
function _v(r) {
  if (r.querySelector("> tr > [headers], > tbody > tr > [headers]"))
    return !1;
  const t = r.querySelectorAll("> tr, > thead > tr, > tbody > tr");
  if (t.length === 0)
    return !1;
  const n = t.map((v) => v.querySelectorAll("> *").map((A) => A.is("th") ? Cv : Av));
  if (n[0].length === 0)
    return !1;
  const s = n[0].length;
  if (!n.every((v) => v.length === s))
    return !1;
  const i = $v(n), a = n.map((v) => v.reduce((A, g) => A + g, 0)), o = Array(i.cols).fill(0).map((v, A) => n.reduce((g, p) => g + p[A], 0)), [u, ...d] = a;
  if (u === i.cols && d.every((v) => v === 0))
    return !0;
  const [l, ...h] = o, y = !!r.querySelector("> thead");
  return !!(l === i.rows && h.every((v) => v === 0) && !y);
}
class Sv extends j {
  constructor(e) {
    super({ ...Dv, ...e });
  ...
  setup() {
    const { strict: e } = this.options;
    this.on("element:ready", (t) => {
      const n = t.target;
      n.is("table") && (e || !_v(n)) && this.validateTable(n);
    });
  }
  validateTable(e) {
    for (const t of e.querySelectorAll("th")) {
      ...
      if (s instanceof me || s && Wl.includes(s))
        continue;
      const i = `<th> element must have a valid scope attribute: ${wv}`, a = (n == null ? void 0 : n.valueLocation) ?? (n == null ? void 0 : n.keyLocation) ?? t.location;
      this.report(t, i, a);
    }
  }
}
...
const Nv = {
  ...
  "element-case": gy,
  "element-name": yy,
  "element-permitted-content": Dy,
  "element-permitted-occurrences": wy,
  "element-permitted-order": Ay,
  "element-permitted-parent": Sy,
  "element-required-ancestor": Ny,
  "element-required-attributes": Fy,
  "element-required-content": Iy,
  "empty-heading": qy,
  "empty-title": xy,
  "form-dup-name": Hy,
  "heading-level": Xy,
  ...
  "id-pattern": eb,
  "input-attributes": rb,
  "input-missing-label": ub,
  "long-title": fb,
  "map-dup-name": yb,
  "map-id-name": vb,
  "meta-refresh": mb,
  "missing-doctype": Eb,
  "multiple-labeled-controls": Db,
  "name-pattern": Ab,
  "no-abstract-role": $b,
  "no-autoplay": Sb,
  "no-conditional-comment": Rb,
  "no-deprecated-attr": Tb,
  "no-dup-attr": Nb,
  "no-dup-class": Fb,
  "no-dup-id": Pb,
  "no-implicit-button-type": kb,
  "no-implicit-input-type": qb,
  "no-implicit-close": xb,
  "no-inline-style": Bb,
  "no-missing-references": Mb,
  "no-multiple-main": Ub,
  "no-raw-characters": Wb,
  "no-redundant-aria-label": Yb,
  "no-redundant-for": Jb,
  "no-redundant-role": Qb,
  "no-self-closing": t0,
  "no-style-tag": n0,
  "no-trailing-whitespace": s0,
  "no-unknown-elements": a0,
  "no-unused-disable": o0,
  "no-utf8-bom": u0,
  "prefer-button": f0,
  "prefer-native-element": m0,
  "prefer-tbody": p0,
  "require-csp-nonce": y0,
  "require-sri": A0,
  "script-element": C0,
  "script-type": _0,
  "svg-focusable": S0,
  ...
  "text-content": Fi,
  "unique-landmark": j0,
  "unrecognized-char-ref": z0,
  "valid-autocomplete": iv,
  "valid-id": ov,
  "void-content": uv,
  "void-style": cv,
  ...Nv
...
const Iv = {
  ...
  "html-validate:a11y": Iv,
  "html-validate:browser": kv,
  "html-validate:document": Ov,
  "html-validate:prettier": qv,
  "html-validate:recommended": xv,
  "html-validate:standard": Lv
};
class Pu {
  /**
   * @internal
...
function pt(r, e) {
  ...
  e.rules && (t.rules = Wt(t.rules, e.rules, { arrayMerge: Wv }));
...
class be {
  ...
  constructor(e, t) {
    ...
    this.config = pt(n, t), this.configurations = /* @__PURE__ */ new Map(), this.resolvers = ku(e), this.metaTable = null, this.plugins = [], this.transformers = Xv(this.config.transform ?? {});
  }
  /**
  ...
  getElementsFromEntry(e) {
    ...
    if (t)
      return [t, null];
    try {
      const n = Uv(this.resolvers, e, { cache: !1 });
  ...
  loadPlugins(e) {
    const t = [], n = Array.from(e), s = (a, o) => {
      if (typeof a != "string") {
        ...
        try {
          const u = Hv(this.resolvers, a, { cache: !0 });
          if (de(u))
            return u.then((d) => {
  ...
  loadConfigurations(e) {
    const t = /* @__PURE__ */ new Map();
    for (const [n, s] of Object.entries(Bv))
  ...
  save(e) {
    const t = {
      ...
      results: Object.keys(this.result).map((n) => {
        const s = Array.from(this.result[n], eE).sort(rE), i = (e ?? []).find((a) => n === a.filename);
        return {
          filePath: n,
          messages: s,
          errorCount: Us(s),
    ...
    return t.errorCount = qu(t.results), t.warningCount = xu(t.results), t;
  }
  isValid() {
...
class xe {
  ...
  constructor(e) {
    ...
    O(this, "dom");
    this.event = new Zv(), this.dom = null, this.metaTable = e.getMetaTable();
  }
  /**
   * Parse HTML markup.
   *
  ...
  consumeAttribute(e, t, n, s) {
    var A;
    const { meta: i } = t, a = this.getAttributeKeyLocation(n), o = this.getAttributeValueLocation(s), u = this.getAttributeLocation(n, s), d = iE(s), l = {
      key: n.data[1],
      value: null,
      quote: null
    };
  ...
  consumeComment(e) {
    ...
    for (const s of sE(t, e.location))
      this.trigger("conditional", {
...
class DE {
  ...
  async validateFile(e, t) {
    const n = await this.getConfigFor(e), s = this.configLoader.getResolvers(), i = await Vt(s, n, e, t), a = new Me(n, xe);
  ...
  validateFileSync(e, t) {
    const n = this.getConfigForSync(e), s = this.configLoader.getResolvers(), i = gE(s, n, e, t);
    return new Me(n, xe).lint(i);
  }
  /**
  ...
  async dumpTokens(e, t) {
    ...
    return new Me(n, xe).dumpTokens(i);
  }
  /**
  ...
  async dumpEvents(e, t) {
    const n = await this.getConfigFor(e), s = this.configLoader.getResolvers(), i = await Vt(s, n, e, t);
    return new Me(n, xe).dumpEvents(i);
  }
  /**
...
`)), a.push("---"), a;
  ...
  async getContextualDocumentation(e, t = "inline") {
    ...
    return new Me(n, xe).getRuleDocumentation(e);
  }
  ...
  async getRuleDocumentation(e, t = null, n = null) {
    ...
    return new Me(await s, xe).getRuleDocumentation({ ruleId: e, context: n });
  }
  /**
   * Get contextual documentation for the given rule.
   *
  ...
  getRuleDocumentationSync(e, t = null, n = null) {
    ...
    return new Me(s, xe).getRuleDocumentation({ ruleId: e, context: n });
  }
  /**
